...
const Instruction = (props) => {
    return (
        <div className={styles.discription}>
            ...
            <section>
                <h3>KROK 1 - Wypełnienij wszystkie pola i zweryfikuj dane</h3>
                ...
                <p> - Po wypełnieniu wszystkich pól kliknij w przycisk <span>SPRAWDŹ DANE</span></p>
                <p> - Jeśli wstępna weryfikacja powiedzie się, kliknij w przycisk <span>NASTĘPNY KROK</span></p>
            ...
            <section>
                ...
                <p>Jeśli wszystko się zgadza, odchać odpowiednie pole pod projektem umowy i kliknij w przycisk <span>NASTĘPNY KROK</span></p>
                <img width={800} src={step2}/>
            </section>
            <section>
                <h3>KROK 3 - Ściągnij wygenerowaną umowę i zachowaj w wybranym miejscu na komputerze</h3>
                <p> Kliknij w przycisk <span>ŚCIĄGAM / NASTĘPNY KROK</span> i zachowaj umowę w wybranym miejscu na swoim komputerze.</p>
            ...
            <section>
                ...
                <p>Kliknij w odpowiednie pole w formularzu i załącz ściągniętą umowę po czym kliknij w przycisk <span>ZAWIERAM UMOWĘ</span></p>
                <img width={800} src={step4}/>
                <p>Za chwilę otrzymasz na swojego maila potwierdzenie zawarcia umowy oraz warunki jej aktywacji.</p>
                <p>To wszystko! Zapraszamy na zajęcia! :)</p>
            </section>
            <section className={styles.rodo}>
                <h3>!! WAŻNE !!</h3>
                <p>Aż do momentu zawarcia umowy wszystkie wprawodzone przez Ciebie dane przechowewane są w twojej przeglądarce internetowej, nie mamy dostępu do nich (RODO).</p>
