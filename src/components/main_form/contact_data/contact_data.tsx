...
type PropsType = {
    ...
    onMotherPhoneNumber: (value: string) => void
    onFatherPhoneNumber: (value: string) => void
    onParrentEmail: (value: string) => void
    onTestingFormText: (value: string) => void
    onTestingForm: (value: string) => void
}
