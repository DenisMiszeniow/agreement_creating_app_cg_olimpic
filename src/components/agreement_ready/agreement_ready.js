...
const Agreement = (props) => {
        useEffect(() => {props.agreementReadyLocalesThunk(props.language, props.agreementReady)}, [props.language])
        ...
        return (
                <div>
                        ...
                        <div className={styles.container}>
                                ...
                                <p className={styles.signatures}><span className={styles.clientSignature}><i>{`Wrocław, ${props.currentDate.getDate()}.${props.currentDate.getMonth() + 1}.${props.currentDate.getFullYear()}`}</i></span><span className={styles.ownerSignature}><i>tutaj będzie twój podpis</i></span></p>
                        ...
                        <div className={styles.checkboxContainer}>                                                                                                                                                                                                                                                                                                                                                                              
                                <input className={styles.checkboxContainer__checkbox} type="checkbox" onClick={onLocalDownloadRoute} defaultChecked={props.acceptAgreement}/>
                                <span className={styles.checkboxContainer__Span}>{props.localesTexts.acceptAgreementText}</span>
                        </div>
                        {
                                props.acceptAgreement 
                                ? <NavLink to={props.downloadRoute} className={styles.linkActive} onClick={onLocalDownloadRoute}>{props.localesTexts.nextStepText}</NavLink>
                                : <div className={styles.linkPassive}>{props.localesTexts.nextStepText}</div> 
                        }
                </div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
        )                                                                                                                                                                                                       
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
