...
//@ts-ignore
import { Step2Container } from "../steps/steps_container.ts"
...
type PropsType = {
        ...
        language: string
        setLocalesThunk: (language: string, agreementReady: string) => void
...
const Agreement: FC<PropsType> = (props) => {
        // eslint-disable-next-line react-hooks/exhaustive-deps
        useEffect(() => { props.setLocalesThunk(props.language, props.agreementReady) }, [props.language])
